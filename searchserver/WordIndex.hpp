...
class WordIndex {
 ...
 private:
  std::unordered_map<string, std::unordered_map<string, Result>> index_;
  size_t num_words_;
  // document : set of word it contains
  std::unordered_map<string, std::unordered_set<string>> doc_to_words_;
};
